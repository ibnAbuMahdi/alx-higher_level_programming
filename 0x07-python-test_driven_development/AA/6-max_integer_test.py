...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_not_list(self):
        """test with other classes not list"""
        self.assertRaises(TypeError, max_integer, "hello")
        self.assertRaises(TypeError, max_integer, {1:2, 3:5})
        self.assertRaises(TypeError, max_integer, 1024)

    def test_not_integer(self):
        """test with list containing none integers"""
        self.assertRaises(TypeError, max_integer, [',ca', 'heol'])
        self.assertRaises(TypeError, max_integeroself.assertRaises(TypeError,
            max_integer, [3, 6.07]))
